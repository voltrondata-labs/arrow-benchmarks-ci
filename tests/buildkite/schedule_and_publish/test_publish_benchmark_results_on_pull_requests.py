...
def verify_pull_comment(input_run_statuses, expected_statuses, expected_build_statuses):
    ...
    expected_comment_body = (
        ...
        "Buildkite builds:\n"
        f"[{expected_build_statuses[0]}] [`{test_benchmarkable_id}` {machine1.name}](https://buildkite.com/apache-arrow/arrow-bci-benchmark-on-{machine1.name}/builds/1)\n"
        f"[{expected_build_statuses[1]}] [`{test_baseline_benchmarkable_id}` {machine1.name}](https://buildkite.com/apache-arrow/arrow-bci-benchmark-on-{machine1.name}/builds/1)\n"
        f"[{expected_build_statuses[2]}] [`{test_baseline_benchmarkable_id}` {machine2.name}](https://buildkite.com/apache-arrow/arrow-bci-benchmark-on-{machine2.name}/builds/1)\n"
